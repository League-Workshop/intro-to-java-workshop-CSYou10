...
public class MadlibsOfTheAmazon {
	...
	public static void main(String[] args) {
		...
		JOptionPane.showInputDialog("If you fing yourself having to corss a piranha-infested river, here's how to do it...");
 ...
 JOptionPane.showMessageDialog(null, "Piranhas are more " + adjective + " during the day, so cross the river \n" 
		 + " at night. Piranhas are attracted to fresh " + liquid + " and will most likely take a bite out of your \n" +
		   bodypart + " if you " + verb + " Whatever you do, if you have an open wound, try to find another way to get \n" +
		  		 " back to the " + place + " Good luck!");
